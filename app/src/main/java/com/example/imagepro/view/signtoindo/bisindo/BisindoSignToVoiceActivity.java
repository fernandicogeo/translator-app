...
public class BisindoSignToVoiceActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public BisindoSignToVoiceActivity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(BisindoSignToVoiceActivity.this, Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(BisindoSignToVoiceActivity.this, new String[]{Manifest.permission.CAMERA}, MY_PERMISSIONS_REQUEST_CAMERA);
        }

        setContentView(R.layout.activity_bisindo_sign_to_voice);
