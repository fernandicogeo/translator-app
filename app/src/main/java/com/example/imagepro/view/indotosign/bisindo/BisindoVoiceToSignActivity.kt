...
import com.example.imagepro.viewmodel.BisindoViewModel
import com.example.imagepro.viewmodel.ViewModelFactory
import java.io.File
import java.util.Locale

class BisindoVoiceToSignActivity : AppCompatActivity() {

    private lateinit var recordButton: Button
    private lateinit var transcriptionText: TextView
    private val REQUEST_CODE_SPEECH_INPUT = 1

    private val bisindoViewModel: BisindoViewModel by viewModels { factory }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bisindo_voice_to_sign)
        ...
        sendButton.setOnClickListener {
            ...
            when {
                text.isEmpty() -> {
                    ...
                    getBisindoVideos(text)
                }
            }
        }
    }

    private fun getBisindoVideos(kalimat: String) {
        when (kalimat.lowercase()) {
            ...
            "kepala sekolah" -> {
                ...
                for (kata in kataKata) {
                    ...
                    bisindoViewModel.getBisindoVideo(finalKata).observe(this) { hasil ->
                        when (hasil) {
    ...
    private fun getVideoForSpecialCase(kalimat: String) {
        ...
        bisindoViewModel.getBisindoVideo(kalimat).observe(this) { hasil ->
            when (hasil) {
                is ResultCondition.LoadingState -> {
                    showLoading(true)
                }
